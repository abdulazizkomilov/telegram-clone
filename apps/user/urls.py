...
urlpatterns = [
    ...
    path('avatar/', views.UserAvatarUploadView.as_view(), name='user-avatar'),
    path('avatar/<uuid:pk>/', views.UserAvatarRetrieveDestroy.as_view(), name='user-avatar-detail-delete'),
    ...
    path('user/status/<uuid:user_id>/', views.UserStatusView.as_view(), name='user-status'),
]
