...
class TestChatListCreateView:
    def test_list_chats(self, api_client, chat_data):
    ...
    def test_create_chat(self, api_client, user_factory):
    ...
    def test_create_chat_already_exists(self, api_client, chat_data):
        """Test that the user can create a chat."""
        chat, owner, user = chat_data
...
class TestChatView:
    ...
    def test_retrieve_chat(self, api_client, chat_data, user_factory, auth_user, expected_status):
        chat, owner, user = chat_data
        client = api_client()
    ...
    def test_delete_chat(self, api_client, chat_data, user_factory, auth_user, expected_status):
