...
def test_custom_user_model():
    ...
    assert User._meta.db_table == EXPECTED_DB_TABLE, f"{MODEL_NAME} model db_table not set"
    assert User._meta.verbose_name == EXPECTED_VERBOSE_NAME, f"{MODEL_NAME} model verbose_name not set"
    assert User._meta.verbose_name_plural == EXPECTED_VERBOSE_NAME_PLURAL, f"{MODEL_NAME} model verbose_name_plural not set"
    assert User._meta.ordering == EXPECTED_ORDERING, f"{MODEL_NAME} model ordering not set"
