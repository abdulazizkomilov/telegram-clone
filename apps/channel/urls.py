...
urlpatterns = [
    ...
    path('<uuid:pk>/messages/', views.ChannelMessageListCreateView.as_view(),
         name='channel-message-list-create'),
    path('<uuid:pk>/messages/schedule/', views.CreateScheduledMessageView.as_view(),
         name='channel-message-create-schedule'),
    path('<uuid:pk>/messages/<uuid:message_id>/', views.ChannelMessageDetailView.as_view(),
         name='channel-message-detail'),
    path('<uuid:pk>/messages/<uuid:message_id>/like/', views.LikeMessageView.as_view(), name='like-message'),
]
